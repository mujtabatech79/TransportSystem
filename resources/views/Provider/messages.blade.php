...
<head>
    ...
    <title>TruckLink - Messages (Provider)</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-4">
            ...
            <a class="nav-link active" href="{{route('messages.conversations')}}"><i class="fas fa-comments"></i> <span>Messages</span></a>
            ...
            <div class="user-info d-flex align-items-center">
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="https://randomuser.me/api/portraits/men/41.jpg" alt="User" style="width: 40px; height: 40px; border-radius: 50%; margin-right: 10px;">
                        <span class="fw-semibold">{{ session('name', 'Provider') }}</span>
                    </a>
                ...
                <div class="conversations-list" id="conversationsList">
                    ...
                    @else
                        <div class="text-center p-4">
                            ...
                            <p class="text-muted">No conversations yet.<br>When customers contact you, messages will appear here.</p>
                        </div>
                    @endif
                </div>
            </div>
    ...
    <script>
            ...
            chatArea.innerHTML = `
                <div class="chat-header">
                    ...
                    <div class="chat-header-info">
                        ...
                        <p><i class="fas fa-circle" style="font-size: 8px; color: #27ae60;"></i> Customer</p>
                    </div>
                </div>
        ...
        function updateUnreadBadge() {
            // Simple reload to update unread counts
            location.reload();
        }
