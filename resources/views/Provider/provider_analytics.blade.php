...
<head>
    ...
    <style>
        ...
        /* Stats Cards - Professional Neutral Style */
        .stat-card {
            background: white;
            border-radius: 20px;
            padding: 20px 24px;
...
<body>
    ...
    <div class="main-content">
        <div class="topbar d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-semibold"><i class="fas fa-chart-line me-2 text-primary"></i>Analytics Dashboard</h5>
        ...
        <div class="content-area">
            ...
            <!-- Main Stats Cards - Professional Neutral Style -->
            <div class="row mb-4">
                <div class="col-md-3 mb-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-sub">From {{ $totalTrips }} completed trips</div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-sub">Deducted from earnings</div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="stat-card">
                ...
                <div class="col-md-3 mb-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-sub">{{ $performanceMetrics['active_vehicles'] }} active vehicles</div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-4 mb-3">
                    <div class="metric-card">
                        ...
                        <div class="metric-label">Average Earnings Per Trip</div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="metric-card">
                ...
                <div class="col-md-4 mb-3">
                    <div class="metric-card">
                        ...
                        <div class="metric-label">Vehicles with Earnings</div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-6 mb-3">
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-chart-line"></i> Monthly Earnings Trend
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-chart-bar"></i> Yearly Earnings Overview
                        </div>
                        <div class="card-body">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-truck"></i> Vehicle Performance & Earnings
                </div>
                            ...
                            <tbody>
                                @forelse($vehicleEarnings as $vehicle)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-danger-custom">Rs {{ number_format($vehicle['total_penalty'], 2) }}</td>
                                        <td class="text-success-custom fw-bold">Rs {{ number_format($vehicle['total_earnings'], 2) }}</td>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-chart-pie"></i> Vehicle-wise Earnings Breakdown
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-5 mb-4 mb-md-0">
                                    <canvas id="vehicleEarningsChart" style="max-height: 300px;"></canvas>
                                </div>
                                <div class="col-md-7">
                                            ...
                                            @if($vehicle['total_trips'] > 0)
                                                <div class="vehicle-item">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="text-end">
                                                            <div class="fw-bold text-success-custom">Rs {{ number_format($vehicle['total_earnings'], 2) }}</div>
                                                    ...
                                                    @if($vehicle['total_penalty'] > 0)
                                                        <div class="mt-2">
                                                            <span class="badge-penalty"><i class="fas fa-exclamation-circle me-1"></i> Penalty: Rs {{ number_format($vehicle['total_penalty'], 2) }}</span>
                                                        </div>
                                                    @endif
                                                </div>
                                            @endif
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-calendar-alt"></i> Monthly Earnings Breakdown
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse($monthlyEarnings as $month)
                                    <tr>
                                        ...
                                        <td>{{ $month['trips'] }}</td>
                                        <td class="text-danger-custom">Rs {{ number_format($month['penalty'], 2) }}</td>
                                        <td class="text-success-custom fw-bold">Rs {{ number_format($month['earnings'], 2) }}</td>
                                    </tr>
                                @empty
                                    <tr>
                            ...
                            <tbody>
                                @forelse($recentBookings as $booking)
                                    <tr>
                                        ...
                                        <td class="text-danger-custom">Rs {{ number_format($booking->penalty_amount, 2) }}</td>
                                        <td class="text-success-custom fw-bold">Rs {{ number_format($booking->actual_fare, 2) }}</td>
                                        <td>{{ $booking->delivered_at ? \Carbon\Carbon::parse($booking->delivered_at)->format('M d, Y') : 'N/A' }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center py-4">No completed trips found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <script>
        ...
        if (vehicleNames.length > 0) {
            ...
            document.getElementById('vehicleEarningsChart').parentElement.innerHTML = '<div class="text-center py-5"><i class="fas fa-chart-pie fa-3x text-muted mb-3"></i><p class="text-muted">No data available for chart</p></div>';
        }
    </script>
</body>
</html>