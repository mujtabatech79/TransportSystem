...
<body>
    ...
    <script>
        ...
        // Fallback route calculation (OSRM)
        ...
        // Select a route - Make it globally accessible
        window.selectRoute = function(routeId) {
            ...
            routeOptionsInput.value = JSON.stringify(availableRoutes);
            
            // Display directions for selected route
            if (route.directions && route.directions.length > 0) {
                displayDirections(route.directions);
            } else {
