...
<head>
    ...
    <title>TruckLink - Find Vehicles</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="topbar d-flex justify-content-between align-items-center">
            <div class="search-box">
                ...
                <input type="text" class="form-control" placeholder="Search vehicles, locations...">
            </div>
        ...
        <div class="content-area">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-1 fw-bold">Find Vehicles</h4>
                    <p class="text-muted mb-0">Search and book from available verified vehicles.</p>
                </div>
                <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('find.vehicle') }}" method="GET">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <a href="{{ route('find.vehicle') }}" class="btn btn-outline-secondary">
                            ...
                            <div class="vehicle-info">
                                ...
                                <div class="action-buttons">
                                    ...
                                    <button class="btn btn-contact" onclick="startConversation({{ $vehicle->user_id }}, null)">
                                        <i class="fas fa-comment-dots me-1"></i> Contact
                                    </button>
    ...
    <script>
            ...
            if (searchInput) {
                searchInput.addEventListener('keyup', function(e) {
                    if (e.key === 'Enter') {
                        ...
                        if (searchTerm) {
                            window.location.href = "{{ route('find.vehicle') }}?search=" + searchTerm;
                        }
                    }
                });
            }
        ...
        // Start conversation with vehicle owner
            ...
            detailModalBody.innerHTML = `
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item-large">
                            ...
                            <span class="detail-value-large">${escapeHtml(vehicle.owner_name || 'N/A')}</span>
                        </div>
                ...
                <div class="d-flex justify-content-end mt-4 gap-2">
                    <button class="btn btn-contact" onclick="startConversationFromModal(${vehicle.id})">
                        <i class="fas fa-comment-dots me-1"></i> Contact Owner
                    </button>
        ...
        function startConversationFromModal(vehicleId) {
            ...
            detailModal.classList.remove('active');
            toastr.info('Please click the Contact button on the vehicle card to start a conversation.');
        }
    </script>
</body>
</html>