    ...
    <div class="main-content">
        ...
        <div class="content-area">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <span class="badge bg-warning fs-6">8 Pending Vehicles</span>
                </div>
            </div>
            ...
            <div class="row mt-4" id="vehicleGrid">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="vehicle-card">
                        <div class="vehicle-image" style="background-image: url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80')">
                            <div class="vehicle-badge">Pending</div>
                        </div>
                        <div class="vehicle-info">
                            <div class="vehicle-title">Truck - ABC-123</div>
                            <div class="vehicle-details">
                                <div class="detail-item">
                                    <span class="detail-label">Owner</span>
                                    <span class="detail-value">Ahmed Khan</span>
                                </div>
                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">General Goods</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Chassis No</span>
                                    <span class="detail-value">CHS123456789</span>
                                </div>
                            </div>
                            <div class="action-buttons">
                                ...
                                <button class="btn btn-outline-primary w-100" onclick="viewVehicleDetails(1)">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="vehicle-card">
                        <div class="vehicle-image" style="background-image: url('https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80')">
                            <div class="vehicle-badge">Pending</div>
                        </div>
                        <div class="vehicle-info">
                            <div class="vehicle-title">Van - XYZ-789</div>
                            <div class="vehicle-details">
                                <div class="detail-item">
                                    <span class="detail-label">Owner</span>
                                    <span class="detail-value">Bilal Ahmed</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Capacity</span>
                                    <span class="detail-value">1500 kg</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Can Carry</span>
                                    <span class="detail-value">Furniture</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Chassis No</span>
                                    <span class="detail-value">CHS987654321</span>
                                </div>
                            </div>
                            <div class="action-buttons">
                                <button class="btn btn-success w-100">
                                ...
                                <button class="btn btn-outline-primary w-100" onclick="viewVehicleDetails(2)">
                                    <i class="fas fa-eye me-1"></i> Details
                                </button>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="vehicle-card">
                        <div class="vehicle-image" style="background-image: url('https://images.unsplash.com/photo-1621330396173-e41b1cafd56a?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80')">
                            <div class="vehicle-badge">Pending</div>
                        </div>
                        <div class="vehicle-info">
                            <div class="vehicle-title">Pickup - DEF-456</div>
                            <div class="vehicle-details">
                                <div class="detail-item">
                                    <span class="detail-label">Owner</span>
                                    <span class="detail-value">Sara Khan</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Capacity</span>
                                    <span class="detail-value">800 kg</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Can Carry</span>
                                    <span class="detail-value">Small Packages</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Chassis No</span>
                                    <span class="detail-value">CHS456789123</span>
                                </div>
                            </div>
                            <div class="action-buttons">
                                <button class="btn btn-success w-100">
                                ...
                                <button class="btn btn-outline-primary w-100" onclick="viewVehicleDetails(3)">
                                    <i class="fas fa-eye me-1"></i> Details
                                </button>
                            </div>
                        </div>
                ...
                if (detailButton) {
                    ...
                    vehicleData = {
                        ...
                        user: {
                            ...
                            email: 'user' + vehicleId + '@example.com',
                            cnic: '12345-6789012-3'
                        },
                        vehicle_image: vehicleImage.replace('url("', '').replace('")', ''),
                        smartcard_image: 'https://images.unsplash.com/photo-1583752028088-91e3e9880b46?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
                        status: "pending"
                    };
                }
            });
